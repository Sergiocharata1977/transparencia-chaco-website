      ...
      <section className="bg-[#024852] py-16 text-white md:py-24">
        <div className="mx-auto max-w-6xl px-4">
          <div className="grid items-center gap-12 md:grid-cols-2">
            ...
            <div className="overflow-hidden rounded-lg border border-white/10 bg-slate-950 shadow-[0_48px_90px_-42px_rgba(0,0,0,0.85)]">
              {/* Barra chrome */}
              ...
              <div className="relative aspect-video">
                ...
                <div className="pointer-events-none absolute left-4 top-4 rounded-lg border border-white/15 bg-slate-900/75 px-4 py-3 text-left backdrop-blur sm:left-6 sm:top-6">
                ...
                <div className="pointer-events-none absolute bottom-4 right-4 hidden rounded-lg border border-white/10 bg-white/95 p-4 text-left shadow-xl sm:block sm:w-[260px]">
          ...
          {municipios.length > 0 ? (
            ...
            <div className="rounded-lg border border-cyan-950/10 bg-white px-6 py-12 text-center shadow-sm">
              <p className="text-sm font-semibold text-slate-700">
                Todavia no hay municipios destacados cargados.
              </p>
              <p className="mt-2 text-sm text-muted-foreground">
                Cuando se publiquen datos reales del observatorio, apareceran en esta seccion.
              </p>
            </div>
          )}
        ...
        <div className="mx-auto max-w-6xl px-4">
          ...
          {ultimosInformes.length > 0 ? (
            ...
            <div className="mx-auto mt-10 max-w-3xl rounded-lg border border-cyan-950/10 bg-[#f7fafb] px-6 py-12 text-center">
              <p className="text-sm font-semibold text-slate-700">No hay publicaciones cargadas.</p>
              <p className="mt-2 text-sm text-muted-foreground">
                El listado se actualizara cuando el equipo publique informes desde el panel.
              </p>
            </div>
          )}
